      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-12">
          ...
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              At Smart Farms, we combine the power of DJI Mavic 3 drone technology
              with Artificial Intelligence (AI) to revolutionize how small-scale
              farmers manage their land and crops. This integration allows us to
              deliver smarter, faster, and more accurate insights for decision-making.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse gap-12 items-center mb-12">
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              Using the Mavic 3’s high-resolution camera, we capture detailed aerial
              images of farmland. These images are then processed through AI
              algorithms to generate precise maps, identify terrain variations, and
              calculate field boundaries with pinpoint accuracy. Our AI tools
              analyze data in real time, helping farmers plan land use more
              efficiently and detect topographical challenges before planting begins.
            </p>
          </div>
          <div>
            <Image
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-12">
          ...
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              We deploy AI models trained to detect crop stress, pest infestations,
              and disease patterns from drone-captured imagery. The Mavic 3 provides
              high-quality visual data, while our AI systems analyze it to flag
              problem areas instantly. This allows farmers to act early, apply
              targeted treatments, and reduce input costs, boosting productivity
        ...
        <div className="flex flex-col md:flex-row-reverse gap-12 items-center mb-12">
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              At Smart Farms, we are redefining crop spraying through the integration
              of AI-driven precision algorithms and advanced drone technology. Our
              solution ensures that farmers apply just the right amount of inputs,
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-12">
          ...
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              Using specialized spraying drones equipped with GPS and obstacle
              avoidance systems, we conduct highly accurate aerial applications of
              fertilizers, pesticides, and herbicides. These drones can cover large
              areas quickly, access difficult terrains, and significantly reduce
        ...
        <div className="flex flex-col md:flex-row-reverse gap-12 items-center mb-12">
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              By avoiding blanket spraying, we minimize chemical runoff and protect
              surrounding ecosystems. This AI-enhanced precision spraying supports
              sustainable agriculture while maximizing crop yields. With Smart Farms,
              crop spraying becomes safer, smarter, and more sustainable, empowering
              farmers with cutting-edge tools to thrive in a changing agricultural
              landscape.
            </p>
          </div>
          <div>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-12">
          ...
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              At Smart Farms, we make fertilizer application more efficient,
              cost-effective, and environmentally conscious through the power of
        ...
        <div className="flex flex-col md:flex-row-reverse gap-12 items-center mb-12">
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              Using drone technology, we apply fertilizers accurately across your
              fields, eliminating guesswork and reducing manual labor. Our drones are
              equipped with advanced dispersion systems and GPS navigation, ensuring
              coverage and the ability to access hard-to-reach areas with ease.
            </p>
          </div>
          <div>
            <Image
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-12">
          ...
          <div className="max-w-prose">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              Before any fertilizer application, our drones perform aerial scans of
              your crops to assess nutrient deficiencies. These images are processed
              by AI algorithms that generate fertility maps, identifying exactly
              where and how much fertilizer is needed. This means you avoid
              over-fertilization, reduce waste, and boost plant health by applying
              nutrients only where they are required.
            </p>
          </div>
        </div>
      </div>
