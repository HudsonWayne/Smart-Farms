  ...
  return (
    <section className="w-full bg-white px-4 md:px-8 lg:px-16 py-16 font-[Georgia]">
      <div className="max-w-7xl mx-auto text-center">
        {/* Section Header */}
        <h2
          className="text-[#72AE1C] text-[36px] font-bold mb-6"
        ...
        <p
          className="text-gray-700 text-[28px] leading-relaxed mx-auto mb-[62px]"
          style={{
            width: "95%",
            maxWidth: "900px",
        ...
        {/* Section 1 Title */}
        <h3
          className="text-[#72AE1C] text-[28px] font-bold text-left mb-8 mt-[80px]"
          style={{ fontFamily: "Georgia, serif" }}
        >
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 text-left -mx-[15px]">
          <div className="px-[15px]">
            ...
            />
            <p className="mt-3 ml-1 font-bold text-[18px]">
        ...
        <div className="text-left mb-4 mt-[60px]">
          <h3
            className="text-[#72AE1C] text-[28px] font-bold mb-2"
            style={{ fontFamily: "Georgia, serif" }}
          >
        ...
        <div className="mt-12 text-left">
          <Link href="/services">
            <button className="bg-[#0C0332] text-white px-6 py-3 text-base font-semibold hover:bg-opacity-90 rounded-md transition duration-200">
              View All
            </button>
          </Link>
        </div>
