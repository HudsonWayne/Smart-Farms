  ...
  return (
    <section className="w-full bg-white px-4 md:px-12 lg:px-20 py-12 font-[Georgia]">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-gray-700 text-lg mb-10 mx-auto" style={{ width: "50%" }}>
          At Smart Farms, we provide innovative solutions to enhance agricultural practices
          for small and medium-scale farmers.
        </p>

        {/* Section 1 Title */}
        <h3 className="text-green-700 text-2xl font-bold text-left mb-2">DJI Mavic 3 Multispectral</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10 mt-[10px]">
          <div className="text-center">
            ...
            />
            <p className="mt-2 text-base font-bold">High Resolution Camera</p>
          </div>
          <div className="text-center">
            <Image
              src="/Rectangle 9.png"
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 text-base font-bold">AI integrated</p>
          </div>
          <div className="text-center">
            <Image
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 text-base font-bold">Multispectral sensor</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-6">
          <div className="text-center">
            <Image
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 text-base font-bold">Precision input delivery</p>
          </div>
          <div className="text-center">
            <Image
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 text-base font-bold">Labor cost reduction</p>
          </div>
          <div className="text-center">
            <Image
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 text-base font-bold">Remote operation capability</p>
          </div>
        </div>
