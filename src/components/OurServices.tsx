      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="mt-[20px] text-left">
            ...
            />
            <p className="mt-2 ml-[5px] font-bold font-[Poppins] text-[21px]">High Resolution Camera</p>
          </div>
          <div className="mt-[20px] text-left">
            <Image
              src="/Rectangle 9.png"
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 ml-[5px] font-bold font-[Poppins] text-[21px]">AI Integrated</p>
          </div>
          <div className="mt-[20px] text-left">
            <Image
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 ml-[5px] font-bold font-[Poppins] text-[21px]">Multispectral Sensor</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="mt-[20px] text-left">
            <Image
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 ml-[5px] font-bold font-[Poppins] text-[21px]">Precision input delivery</p>
          </div>
          <div className="mt-[20px] text-left">
            <Image
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 ml-[5px] font-bold font-[Poppins] text-[21px]">Labor cost reduction</p>
          </div>
          <div className="mt-[20px] text-left">
            <Image
              ...
              className="w-full object-cover"
            />
            <p className="mt-2 ml-[5px] font-bold font-[Poppins] text-[21px]">Remote operation capability</p>
          </div>
        </div>
