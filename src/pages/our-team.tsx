    ...
    <div className="max-w-7xl mx-auto px-4 py-12" style={{ fontFamily: "Georgia, serif" }}>
      ...
      <div className="grid md:grid-cols-3 gap-12">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-700 font-medium text-lg">Founder and CEO</p>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-700 font-medium text-lg">Human Resources (HR) Manager</p>
          <p className="text-gray-600 text-lg mt-2">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-700 font-medium text-lg">Chief Operating Officer (COO)</p>
          <p className="text-gray-600 text-lg mt-2">
      ...
      <div className="mt-16 text-center">
        <h2 className="text-4xl font-bold mb-[70px]" style={{ color: "#72AE1C" }} mb-4>
          The driving force for Smart Farms
        </h2>
        <p className="text-lg text-gray-700 max-w-7xl mx-auto mt-4 mb-[70px]">
