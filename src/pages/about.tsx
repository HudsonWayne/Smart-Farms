    ...
    <>
        ...
        <div className="relative z-10 px-4 md:px-8 text-center max-w-7xl mx-auto">
          <h1
            ...
            style={{
              ...
              fontWeight: "bold",
              color: "#72AE1C"  // Changed from green to #72AE1C
            }}
          >
            About Us
          </h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mt-10 mb-10 md:flex-row max-w-7xl mx-auto px-4">
        ...
        <div className="max-w-prose">
          <h2 className="text-[#72AE1C] text-3xl font-bold mb-6" style={{ fontFamily: "Georgia, serif" }}>
            Who We Are
          </h2>
      ...
      <div className="relative flex justify-center items-center my-12">
        <h2 className="text-[#72AE1C] text-3xl font-bold mb-4 text-center" style={{ fontFamily: "Georgia, serif" }}>
      ...
      <div className="py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto px-4">
          ...
          <div className="bg-[#190040] text-white p-8 rounded-xl shadow-xl hover:scale-105 transition-transform ease-in-out duration-300 text-center">
            <h3 className="text-2xl font-bold mb-4" style={{ color: "#72AE1C" }}>Sustainability</h3>
            <p className="text-sm">
          ...
          <div className="bg-[#190040] text-white p-8 rounded-xl shadow-xl hover:scale-105 transition-transform ease-in-out duration-300 text-center">
            <h3 className="text-2xl font-bold mb-4" style={{ color: "#72AE1C" }}>Innovation</h3>
            <p className="text-sm">
          ...
          {/* Technology */}
          <div className="bg-[#190040] text-white p-8 rounded-xl shadow-xl hover:scale-105 transition-transform ease-in-out duration-300 text-center">
            <h3 className="text-2xl font-bold mb-4" style={{ color: "#72AE1C" }}>Technology</h3>
            <p className="text-sm">
          ...
          {/* Climate Conscious */}
          <div className="bg-[#190040] text-white p-8 rounded-xl shadow-xl hover:scale-105 transition-transform ease-in-out duration-300 text-center">
            <h3 className="text-2xl font-bold mb-4" style={{ color: "#72AE1C" }}>Climate Conscious</h3>
            <p className="text-sm">
